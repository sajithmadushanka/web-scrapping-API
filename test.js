...
app.get("/news", async (req, res) => {
  ...
  const urlList = ['https://www.bbc.co.uk/search?q=Ai+new&d=HOMEPAGE_GNL','https://www.bbc.co.uk/search?q=Ai+new&d=HOMEPAGE_GNL&page=2']
  ...
  var newsList=[];
    ...
    // Combine the list of image sources and the list of data
      newsList.push(imgList.map((src, index) => {
